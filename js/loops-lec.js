...
do{
    var myOtherQuesion = confirm("Would you like to exit?");
...
do{
    var color = prompt(message: "what is your favorite color?")
}while(color !== "blue");
...
// To do things never and over again without reapeating yourself!
...
for (var index = 0; < randomColors.length;) increment){
